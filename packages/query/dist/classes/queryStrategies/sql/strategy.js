...
class SqlStrategy {
    ...
    build(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.close();
            this.client = yield Client.createConnection(settings);
    ...
    raw(query, params = []) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield helpers_1.queryResolver(this.client, query, params);
        });
    }
    sum(table, column, condition) {
        return __awaiter(this, void 0, void 0, function* () {
            const stringcondition = condition && helpers_1.resolveQueryPart(condition);
            return yield helpers_1.queryResolver(this.client, `SELECT SUM(${column}) FROM ${table}${stringcondition ? ` WHERE ${stringcondition[0]}` : ""}`, stringcondition && stringcondition[1]);
        });
    }
    avg(table, column, condition) {
        return __awaiter(this, void 0, void 0, function* () {
            const stringcondition = condition && helpers_1.resolveQueryPart(condition);
            return yield helpers_1.queryResolver(this.client, `SELECT AVG(${column}) FROM ${table}${stringcondition ? ` WHERE ${stringcondition[0]}` : ""}`, stringcondition && stringcondition[1]);
        });
    }
    count(table, column, condition) {
        return __awaiter(this, void 0, void 0, function* () {
            const stringcondition = condition && helpers_1.resolveQueryPart(condition);
            return Object.values((yield helpers_1.queryResolver(this.client, `SELECT COUNT(${column}) FROM ${table}${stringcondition ? ` WHERE ${stringcondition[0]}` : ""}`, stringcondition && stringcondition[1]))[0])[0];
        });
    }
    // -------------------------------------------------
    // Table methods
    ...
    runMigrations() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield helpers_1.queryResolver(this.client, "SET FOREIGN_KEY_CHECKS=0;");
            ...
            yield helpers_1.queryResolver(this.client, "SET FOREIGN_KEY_CHECKS=1;");
