...
const types = {
    ...
    object: (value, args) => typeof value === "object" && args.filter(a => Object.keys(value).find(v => v.match(a))).length === 0,
...
const rule = {
    ...
    onValidate: ({ value, args, rules, key }) => {
        if (!args || args.length === 0) {
            throw new InvalidRuleException_1.default(`Rule 'notIn' for field ${key} has invalid number of arguments`, { value, args, rules, key });
        }
