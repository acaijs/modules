...
var InvalidRuleException = class extends utils.CustomException {
...
var rule16 = {
  onValidate: ({ value, args }) => {
    if (args && args[0])
      return luxon.DateTime.fromFormat(value, args[0]).isValid;
    return luxon.DateTime.fromISO(value).isValid;
  },
