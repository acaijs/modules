...
const Stubber_1 = require("./src/modules/Stubber");
const listStubs_1 = require("./src/utils/listStubs");
...
if (!action) {
    ...
    listStubs_1.default((args.find(i => i.match("--stubDir=")) || "--stubDir=/stubs").replace("--stubDir=", ""));
    console.log("");
}
    ...
    const stubber = new Stubber_1.default(args, (args.find(i => i.match("--stubDir=")) || "--stubDir=/stubs").replace("--stubDir=", ""));
    stubber.copy();
    stubber.inject();
    console.log("");
}
